...
public class HamburgerMenuAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public HamburgerMenuAdapter(@NonNull Context aContext, WindowViewModel viewModel) {
        mContext = aContext;
        ...
        mViewModel = new ViewModelProvider(
                ...
                .get(String.valueOf(((VRBrowserActivity) mContext).getFocusedWindow().hashCode()), WindowViewModel.class);

        Log.d("aaaaaaaa" ,"mViewModel.getIsPrivateSession().getValue().get() =" +mViewModel.getIsPrivateSession().getValue().get());
    }
    ...
    private View.OnHoverListener mHoverListener = (view, motionEvent) -> {
        ...
        if(mViewModel.getIsPrivateSession().getValue().get()){
            label.setTextColor(R.color.fog);
        }else{
            label.setTextColor(R.color.fog_bg);
        }
