...
public class HamburgerMenuWidget extends UIWidget implements
    ...
    public void updateUI() {
        ...
        mViewModel = new ViewModelProvider(
                ...
                .get(String.valueOf(((VRBrowserActivity) getContext()).getFocusedWindow().hashCode()), WindowViewModel.class);
        binding.setViewmodel(mViewModel);
        mAdapter = new HamburgerMenuAdapter(getContext(),mViewModel);
        ...
        if (item != null) {
            switch (uaMode) {
                case WSessionSettings.USER_AGENT_MODE_DESKTOP: {
                    if(mViewModel.getIsPrivateSession().getValue().get()){
                        item.setIcon(R.drawable.ic_icon_ua_desktop_private);
                    }else{
                ...
                case WSessionSettings.USER_AGENT_MODE_VR: {
                    if(mViewModel.getIsPrivateSession().getValue().get()) {
                        item.setIcon(R.drawable.ic_icon_ua_default_private);
                    }else{
...
//        }
        ...
        mItems.add(new HamburgerMenuAdapter.MenuItem.Builder(
                ...
                .withIcon(mViewModel.getIsPrivateSession().getValue().get() ? R.drawable.ic_icon_resize_private : R.drawable.ic_icon_resize )
                .build());
//
//        if (mSendTabEnabled) {
//            mItems.add(new HamburgerMenuAdapter.MenuItem.Builder(
