...
public class WindowViewModel extends AndroidViewModel {
    ...
    private MutableLiveData<ObservableBoolean> isTabVisible;
    private MutableLiveData<ObservableBoolean> isSettingVisible;
    ...
    public WindowViewModel(Application application) {
        ...
        isSettingVisible = new MutableLiveData<>(new ObservableBoolean(false));
        isTabVisible = new MutableLiveData<>(new ObservableBoolean(false));
        ...
        isInsecureVisible.addSource(isSettingVisible, mIsInsecureVisibleObserver);
        isInsecureVisible.addSource(isTabVisible, mIsInsecureVisibleObserver);
        ...
        isUrlBarButtonsVisible.addSource(isSettingVisible, mIsUrlBarButtonsVisibleObserver);
        isUrlBarButtonsVisible.addSource(isTabVisible, mIsUrlBarButtonsVisibleObserver);
    ...
    private Observer<Spannable> mTitleBarUrlObserver = new Observer<Spannable>() {
        ...
        public void onChanged(Spannable aUrl) {
            ...
            }else if (isTabVisible.getValue().get()) {
                url = getApplication().getString(R.string.tabs_tray_tooltip);
            }else if (isSettingVisible.getValue().get()) {
                url = getApplication().getString(R.string.addons_details_settings);
        ...
        public void onChanged(ObservableBoolean o) {
            ...
            if (isInsecure.getValue().get()) {
                if (UrlUtils.isPrivateAboutPage(getApplication(), aUrl) ||
                        ...
                        isSettingVisible.getValue().get() ||
                        isTabVisible.getValue().get() ||
    ...
    private String getHintValue() {
        if (isLibraryVisible.getValue().get()) {
            ...
            return getApplication().getString(R.string.tabs_tray_tooltip);
        }else if (isSettingVisible.getValue().get()) {
            return getApplication().getString(R.string.addons_details_settings);
        } else {
    ...
    public void setIsSettingVisible(boolean isSettingVisible) {
        this.isSettingVisible.postValue(new ObservableBoolean(isSettingVisible));
        this.url.postValue(this.getUrl().getValue());
    }

    public void setIsSettingPanelVisible(boolean isVisible) {
        setIsSettingVisible(isVisible);
    }

    public void setIsTabLibraryVisible(boolean isTabLibraryVisible) {
        this.isTabVisible.postValue(new ObservableBoolean(isTabLibraryVisible));
        this.url.postValue(this.getUrl().getValue());
    }
    public void setIsTabPanelVisible(boolean isVisible) {
        setIsTabLibraryVisible(isVisible);
    }
    ...
    @NonNull
    public MutableLiveData<ObservableBoolean> getIsTabVisible() {
        return isTabVisible;
    }
    @NonNull
    public MutableLiveData<ObservableBoolean> getIsSettingVisible() {
