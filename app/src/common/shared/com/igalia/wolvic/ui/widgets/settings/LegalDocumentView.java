...
public class LegalDocumentView extends SettingsView {
    ...
    private SettingsHeader mHeadLayout;
    ...
    protected void updateUI() {
        ...
        mHeadLayout = findViewById(R.id.header_layout);
        // Header
        if (mLegalDocument == LegalDocument.TERMS_OF_SERVICE)
            mHeadLayout.setTitle(R.string.settings_terms_service);
        else
            mHeadLayout.setTitle(R.string.settings_privacy_policy);

        mHeadLayout.setBackClickListener(view -> {
